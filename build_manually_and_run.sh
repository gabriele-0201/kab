...
~/opt/cross/bin/i686-elf-ld -T src/linker_viktor.ld --gc-sections src/start.o src/interrupts/interrupt_handlers.o target/x86_64-gab_os/debug/libkernel.a -o gab_kernel.elf
